<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hakkimizda.aspx.cs" Inherits="DeneyBilim.hakkimizda" %>
    ...
    <div id="ekran">
       ...
       <a href="Default.aspx"> <img src="resimler/1giagx.gif" width="200" /></a>
            ...
            <div class="icerik-deneyler">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; DeneyBilim web projesi Mert Tokama, Kenan Keskin ve Mustafa Doğan tarafından geliştirilen bir içerik paylaşım sitesidir. İsminden de anlaşıldığı üzere sitenin içeriklerinin &quot;Deney&quot; ve &quot;Bilimsel Haberler&quot; olduğunu söyleyebilirim. Türkiye de bilimsel haberleri ve eğlenceli içerikleri, merak edilen soruları deneyerek yanıtlayanları bir arada birçok detaylı kategoriye ayırarak arşivleyen ve eğlenceli şekilde sunan bir web sitesi bulunmamaktadır. Proje ekibimiz gibi çoğu insanın bu tür içeriklerden hoşlandığını ve bu eksikliğin tamamlanması gerektiğini düşüyoruz. İnsanların sıkılmadan saatlerce içerisinde kalabileceği ve hem eğlenip hem de birçok soruya yanıt bulmalarını sağlayabilecek bir web sitesi projesidir. </div>
                </div>
        ...
        <asp:Panel ID="kayitpanel" runat="server">
            <asp:SqlDataSource ID="SqlDataSource8" runat="server" connectionString="Data Source=DESKTOP-IGQ966L;Initial Catalog=BilimDeney;Integrated Security=True" SelectCommand="SELECT * FROM [icerik]"></asp:SqlDataSource>
        </asp:Panel>
