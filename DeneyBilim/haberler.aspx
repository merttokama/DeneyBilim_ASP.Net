<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="haberler.aspx.cs" Inherits="DeneyBilim.haberler" %>
...
<body>
    ...
    <div id="ekran">
        ...
        <div class="logo">
           <a href="Default.aspx"> <img src="resimler/1giagx.gif" width="200" /></a>
            ...
            <div class="icerik-deneyler">
                   ...
                   <asp:Label ID="Label1" runat="server" Text="Haberler" ></asp:Label>
                            <br /> <br />

                            <asp:DataList ID="DataList7" runat="server" Font-Bold="True" HorizontalAlign="Left" RepeatColumns="1" DataKeyField="icerikid" DataSourceID="SqlDataSource7">
                                <ItemTemplate>
                                 <a href="icerikler.aspx?ID=<%# Eval("icerikid") %>" >   <img src="kapakresimleri/<%# Eval("icerikfotograf") %>" height="100" style="width: 250px" />
                          </a>          <a href="icerikler.aspx?ID=<%# Eval("icerikid") %>" >  <%# Eval("icerikbaslik") %> </a>
        ...
        <asp:Panel ID="kayitpanel" runat="server">
            <asp:SqlDataSource ID="SqlDataSource7" runat="server" connectionString="Data Source=DESKTOP-IGQ966L;Initial Catalog=BilimDeney;Integrated Security=True" SelectCommand="SELECT icerikid,icerikfotograf,icerikbaslik FROM icerik WHERE icerikturu LIKE '%Haber%' ORDER BY icerikzaman ASC"></asp:SqlDataSource>
        </asp:Panel>
