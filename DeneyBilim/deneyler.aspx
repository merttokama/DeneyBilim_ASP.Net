<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="deneyler.aspx.cs" Inherits="DeneyBilim.deneyler" %>
...
<body>
    <form id="form1" runat="server">
                ...
                <div class="sol-taraf">
                    ...
                    <div class="icerik-deneyler">
                        <div class="haberler">
                            ...
                            <asp:Label ID="Label1" runat="server" Text="Deneyler" ></asp:Label>
                            <br /> <br />

                            <asp:DataList ID="DataList4" runat="server" Font-Bold="True" HorizontalAlign="Left" RepeatColumns="1" DataKeyField="icerikid" DataSourceID="SqlDataSource4">
                                <ItemTemplate>
        ...
        <asp:Panel ID="kayitpanel" runat="server">
            <asp:SqlDataSource ID="SqlDataSource4" connectionString="Data Source=DESKTOP-IGQ966L;Initial Catalog=BilimDeney;Integrated Security=True" runat="server" SelectCommand="SELECT * FROM [icerik]"></asp:SqlDataSource>
            <asp:Label ID="LabelDeneyDeneme" runat="server" Visible="False"></asp:Label>
        </asp:Panel>
