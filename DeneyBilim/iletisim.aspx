<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="iletisim.aspx.cs" Inherits="DeneyBilim.iletisim" %>
...
<body>
    ...
    <div id="ekran">
           ...
           <a href="Default.aspx"> <img src="resimler/1giagx.gif" width="200" /></a>
            ...
            <div class="icerik-deneyler">
                <div class="iletisimalan">
                    Bize Ulaşın:<br />
                    <br />
                    <a href="http://www.facebook.com/deneybilim.com" target="_blank"><img src="iletisim/facebook.png"/><asp:Label ID="Label1" runat="server" Text="Facebook ile iletişime geçmek için tıklayınız.."></asp:Label></a><br/>
                     <a href="http://www.twitter.com/deneybilim_com" target="_blank"><img src="iletisim/twitter.png" /> <asp:Label ID="Label2" runat="server" Text="Twitter ile iletişime geçmek için tıklayınız.."></asp:Label></a><br/>
                     <a href="http://www.instagram.com/deneybilim/" target="_blank"><img src="iletisim/instagram.png" /><asp:Label ID="Label3" runat="server" Text="İnstagram ile iletişime geçmek için tıklayınız.."></asp:Label></a><br/>
                     <img src="iletisim/gmail.png" /><asp:Label ID="Label4" runat="server" Text=" Mail Adresimiz: deneybilim.com@gmail.com"></asp:Label><br/>
               </div></div>
                </div>
        ...
        <asp:Panel ID="kayitpanel" runat="server">
            <asp:SqlDataSource ID="SqlDataSource12" runat="server" connectionString="Data Source=DESKTOP-IGQ966L;Initial Catalog=BilimDeney;Integrated Security=True" SelectCommand="SELECT * FROM [icerik]"></asp:SqlDataSource>
        </asp:Panel>
