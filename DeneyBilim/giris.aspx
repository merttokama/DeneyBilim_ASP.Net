<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="giris.aspx.cs" Inherits="DeneyBilim.giris" %>
...
<body>
    ...
    <div id="ekran">
        ...
        <div class="logo">
         ...
         Kullanıcı Adı :<asp:TextBox ID="kullaniciaditext" runat="server" BorderColor="Black" defaultbutton="girisyap"></asp:TextBox><br />
    Şifre :
    <asp:TextBox ID="sifretext" runat="server" BorderColor="Black" TextMode="Password" defaultbutton="girisyap"></asp:TextBox><br />
    <asp:Button ID="girisyap" Text="GİRİŞ YAP" runat="server" OnClick="girisyap_Click1"/>
