<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="profilonay.aspx.cs" Inherits="DeneyBilim.profilonay" %>
    ...
    <div id="ekran">
     ...
     <a href="Default.aspx"> <img src="resimler/1giagx.gif" width="200" /></a>
            ...
            <div class="icerik-deneyler">
                ...
                Değişikliğiniz başarı ile gerçekleşti.<br />
        ...
        <asp:Panel ID="kayitpanel" runat="server">
            <asp:SqlDataSource ID="SqlDataSource18" runat="server" connectionString="Data Source=DESKTOP-IGQ966L;Initial Catalog=BilimDeney;Integrated Security=True" SelectCommand="SELECT * FROM [icerik]"></asp:SqlDataSource>
        </asp:Panel>
